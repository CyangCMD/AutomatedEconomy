...
Because this is a repository that spans every paradigm, every modular that exists in their paradigm would be built on an inherited tree of concepts; each depending on the axiomatics of the previous modular (SEE AEco_Modularization.md for info).
...
[DASH LINE GOES HERE] [DASH LINE GOES HERE] [DASH LINE GOES HERE]
